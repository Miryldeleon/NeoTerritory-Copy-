...
Inside the body, it mainly handles match source text with regular expressions, fill local output fields, and branch on local conditions.
...
flowchart TD
    ...
    N0["Handle literal from condition"]
    N1["Match regex"]
    N2["Populate outputs"]
